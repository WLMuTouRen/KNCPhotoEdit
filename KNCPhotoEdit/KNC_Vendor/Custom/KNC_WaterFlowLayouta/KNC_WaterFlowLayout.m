...
#import "KNC_WaterFlowLayout.h"

/** 默认的列数*/
static const NSInteger KNC_DefaultColumeCount = 2;
/** 默认的行数*/
static const NSInteger KNC_DefaultRowCount = 5;

/** 每一列之间的间距*/
static const NSInteger KNC_DefaultColumeMargin = 10;
/** 每一行之间的间距*/
static const CGFloat KNC_DefaultRowMargin = 10;
/** 边缘之间的间距*/
static const UIEdgeInsets KNC_DefaultEdgeInset = {10, 10, 10, 10};

///** 每一行之间的间距*/
//static const CGSize KNC_DefaultHeaderSize = CGSizeMake(0, 66);
///** 每一行之间的间距*/
//static const CGSize KNC_DefaultFooterSize = CGSizeMake(0, 66);


@interface KNC_WaterFlowLayout ()
...
@implementation KNC_WaterFlowLayout
...
-(CGFloat)columnMargin {
    if ([self.delegate respondsToSelector:@selector(columnMarginInWaterFlowLayout:)]) {
        ...
        return  KNC_DefaultColumeMargin;
    }
}
...
-(void)prepareLayout {
    ...
    if (self.flowLayoutStyle == KNC_WaterFlowVerticalEqualWidth) {
    ...
    }else if (self.flowLayoutStyle == KNC_WaterFlowHorizontalEqualHeight){
    ...
    }else if (self.flowLayoutStyle == KNC_WaterFlowVerticalEqualHeight || self.flowLayoutStyle == KNC_LineWaterFlow){
    ...
    }else if(self.flowLayoutStyle == KNC_WaterFlowHorizontalGrid){
    ...
    }else if (self.flowLayoutStyle == KNC_WaterFlowCoustom) {
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.flowLayoutStyle == KNC_WaterFlowVerticalEqualWidth) {
    ...
    }else if(self.flowLayoutStyle == KNC_WaterFlowVerticalEqualHeight){
        
        attrs.frame = [self itemFrameOfVHWaterFlow:indexPath];
        
    }else if(self.flowLayoutStyle == KNC_LineWaterFlow){
        ...
        attrs.frame = [self itemFrameOfCustomWaterFlow:indexPath];
    }
...
/*
 ...
 {
 if (self.flowLayoutStyle == KNC_LineWaterFlow) {
...
//自定义宽高 item不等宽不等高
- (CGRect)itemFrameOfCustomWaterFlow:(NSIndexPath *)indexPath{
