...
//当前绘制的信息
@property (nonatomic, strong) KNC_MosaicPath *currentPath;
...
//QC_PS_MosaicManager
@property(nonatomic ,strong) KNC_MosaicManager *mosaiManager;
@end

@implementation KNC_MosaicView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _currentPath = [[KNC_MosaicPath alloc]init];
...
- (void)setOriginalImage:(UIImage *)originalImage{
    ...
    _mosaiManager = [[KNC_MosaicManager alloc]initWithOriImage:originalImage];
