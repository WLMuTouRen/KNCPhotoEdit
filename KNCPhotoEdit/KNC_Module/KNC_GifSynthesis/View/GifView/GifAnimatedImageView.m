...
@optional
- (void)debug_animatedImageView:(GifAnimatedImageView *)animatedImageView waitingForFrame:(NSUInteger)index duration:(NSTimeInterval)duration;
@end
#endif


@interface GifAnimatedImageView ()
...
- (void)setAnimatedImage:(GifAnimatedImage *)animatedImage
{
